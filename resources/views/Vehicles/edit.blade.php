                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="Vehicles_name" value="{{$result->vehicle_name}}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="description" value="{{$result->description}}" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">{{__("Description (Arabic)")}}</label>
                                <input class="form-control" type="text" name="description_arabic" value="{{$result->description_arabic}}" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">{{__("Type")}}</label>
                                <input class="form-control" type="text" name="type" value="{{$result->type}}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control numeric" type="tel" value="{{$result->daily_ticket_price_ESD}}" name="daily_ticket_price_egp">
                            </div>
                             <div class="form-group">
                                ...
                                <input class="form-control numeric" type="tel" value="{{$result->safari_ticket_price_ESD}}" name="Safari_ticket_price_egp">
                            </div>
                        ...
                        <div class="col-md-12 text-right">
                            <div class="btn-group">
                                <input type="hidden"  id="input_id" value="{{$result->id}}">
                                <button class="btn btn-warning" type="button" onclick="window.location.href='{{url('Vechiles')}}'">
