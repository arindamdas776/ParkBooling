...
<div class="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form action="{{route('newsevents.store')}}" id="addForm" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="3" cols="3" type="text" name="short_description" required></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="summernote" name="body" rows="5" cols="10" class="form-control"></textarea>
                            </div>
                            <div class="form-group">
