        ...
        <div class="card-body ">
            <form id="LoginForm" method="POST" action="{{ route('admin.login') }}">
                ...
                <div class="form-group text-center m-t-20">
                    <div class="col-xs-12">
                        <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" id="signupBtn"  type="submit">{{ __('ADMIN SIGN IN') }}</button>
                    </div>
                </div>
            ...
            <form action="" class="d-none">
                <div class="form-group ">
                    <div class="col-xs-12">
                    <h3 class="text-center">{{__('Recover Password')}}</h3>
                        <p class="text-blcck">
