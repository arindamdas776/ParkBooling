								...
								<div class="row">
									...
									<div class="col-lg-6 mb-2">
										...
										<select name="applicant_status_1_t5" id="applicant_status_1_t5"
											...
											<option value="{{$item}}"
												{{($tab1['applicant_status_1_t5'] == $item) ? 'selected' : ''}}>
												{{$item}}</option>
											@endforeach
										</select>
									</div>
									...
									<div class="col-lg-4 mt-3">
										...
										<div class="form-group">
											<input type="number" name="id_number_1_t5" class="form-control input-sm"
												value="{{$tab1['id_number_1_t5']}}">
										</div>
									</div>
									<div class="col-lg-4">
										<label for="">PASSPORT NUMBER (FOR NON EGYPTIAN) <code>*</code></label>
										<div class="form-group">
											<input type="text" name="passport_number_1_t5" class="form-control input-sm"
												value="{{$tab1['passport_number_1_t5']}}">
										</div>
									</div>
									<div class="col-lg-4">
									...
									<div class="col-lg-4 mt-3">
										...
										<div class="form-group">
											<input type="text" name="actual_place_of_res_1_t5"
												...
												value="{{$tab1['actual_place_of_res_1_t5']}}">
										</div>
									</div>
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<textarea class="form-ccontrol" style="width: 100%;" name="corrs_add_1_t5"
												id="corrs_add_1_t5" cols="5"
												rows="3">{{$tab1['corrs_add_1_t5']}}</textarea>
										</div>
									</div>
									<div class="col-lg-6 mb-2">
										...
										<div class="form-group">
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="land_with_code_ext_1_t5" id="land_with_code_ext_1_t5"
														...
														<option value="{{$country->phonecode}}"
															{{($tab1['land_with_code_ext_1_t5'] == $country->phonecode) ? 'selected' : ''}}>
												...
												<input type="number" name="land_with_code_1_t5"
													class="form-control input-sm"
													value="{{$tab1['land_with_code_1_t5']}}">
											</div>
										</div>
									</div>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="fax_with_code_ext_1_t5" id="fax_with_code_ext_1_t5"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab1['fax_with_code_ext_1_t5'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="mobile_personal_ext_1_t5"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab1['mobile_personal_ext_1_t5'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
												...
												<input type="number" name="mobile_personal_1_t5"
													class="form-control input-sm"
													value="{{$tab1['mobile_personal_1_t5']}}">
											</div>
										</div>
									</div>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="mobile_work_ext_1_t5" id="mobile_work_ext_1_t5"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab1['mobile_work_ext_1_t5'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
												...
												<input type="number" name="mobile_work_1_t5"
													class="form-control input-sm"
													value="{{$tab1['mobile_work_ext_1_t5']}}">
											</div>
										</div>
									</div>
									...
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<input type="email" name="email_personal_1_t5" class="form-control input-sm"
												value="{{$tab1['email_personal_1_t5']}}">
										</div>
									</div>
									<div class="col-lg-4 mb-2">
									...
									<div class="col-lg-4 mb-2">
										...
										<select name="reqtype_1_t5" id="reqtype_1_t5" class="form-control select2">
											...
											<option value="{{$item}}"
												{{($tab1['reqtype_1_t5'] == $item) ? 'selected' : ''}}>{{$item}}
											</option>
											@endforeach
										</select>
									</div>
									...
									<div class="col-lg-4 mb-2">
										<label>NOTES</label>
										<textarea name="notes_1_t5" id="notes_1_t5" cols="30"
											rows="2"> {{$tab1['notes_1_t5']}}</textarea>
									</div>

									<div class="col-lg-12">
										<button class="btn btn-default float-right ml-2"
											onclick="wiz5_nextbutton(this)">Save & Next</button>
									</div>
								</div>
							</section>
							...
							<section data-tab="2">
								<div class="row">
										...
										<div class="col-lg-12">
											...
											<div class="checkbox">
												<label style="margin-left:30px;"><input type="checkbox"
														name="same_as_applicant_2_t5"
														value="{{($tab2['same_as_applicant_2_t5'] == "y") ? 'y' : ''}}"
														{{($tab2['same_as_applicant_2_t5'] == "y") ? 'checked' : ''}}>Same
													as applicants
													data</label>
											</div>
										</div>
									...
									<div class="col-lg-4">
										...
										<div class="form-group">
											<input type="text" name="passport_number_2_t5" class="form-control input-sm"
												value="{{$tab2['passport_number_2_t5']}}">
										</div>
									</div>
									...
									<div class="col-lg-4">
										...
										<div class="form-group">
											<input type="text" name="actual_place_of_res_2_t5"
												class="form-control input-sm"
												value="{{$tab2['actual_place_of_res_2_t5']}}">
										</div>
									</div>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="land_with_code_ext_2_t5" id="land_with_code_ext_2_t5"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab2['land_with_code_ext_2_t5'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
												...
												<input type="number" name="land_with_code_2_t5"
													class="form-control input-sm"
													value="{{$tab2['land_with_code_2_t5']}}">
											</div>
										</div>
									</div>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="fax_with_code_ext_2_t5" id="fax_with_code_ext_2_t5"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab2['fax_with_code_ext_2_t5'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="mobile_personal_ext_2_t5"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab2['mobile_personal_ext_2_t5'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
												...
												<input type="number" name="mobile_personal_2_t5"
													class="form-control input-sm"
													value="{{$tab2['mobile_personal_2_t5']}}">
											</div>
										</div>
									</div>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="mobile_work_ext_2_t5" id="mobile_work_ext_2_t5"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab2['mobile_work_ext_2_t5'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
												...
												<input type="number" name="mobile_work_2_t5"
													class="form-control input-sm"
													value="{{$tab2['mobile_work_ext_2_t5']}}">
											</div>
										</div>
									</div>
									...
									<div class="col-lg-4 mb-2">
										<label for="">EMAIL (PERSONAL)</label>
										<div class="form-group">
											<input type="email" name="email_personal_2_t5" class="form-control input-sm"
												value="{{$tab2['email_personal_2_t5']}}">
										</div>
									</div>
									...
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<input type="text" name="entity_name_arabic_3_t5"
												class="form-control input-sm"
												value="{{$tab3['entity_name_arabic_3_t5']}}">
										</div>
									</div>
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<input type="text" name="entity_name_english_3_t5"
												class="form-control input-sm"
												value="{{$tab3['entity_name_english_3_t5']}}">
										</div>
									</div>
									...
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<input type="text" name="membership_number_3_t5"
												class="form-control input-sm"
												value="{{$tab3['membership_number_3_t5']}}">
										</div>
									</div>
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<input type="number" name="commercial_reg_no_3_t5"
												class="form-control input-sm"
												value="{{$tab3['commercial_reg_no_3_t5']}}">
										</div>
									</div>
									...
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<textarea name="address_of_the_entity_3_t5" id="address_of_the_entity_3_t5"
												cols="30" rows="3">{{$tab3['address_of_the_entity_3_t5']}}</textarea>
										</div>
									</div>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="landline_no_ext_3_t5" id="landline_no_ext_3_t5"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab3['landline_no_ext_3_t5'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
												...
												<input type="number" name="landline_no_3_t5"
													class="form-control input-sm" value="{{$tab3['landline_no_3_t5']}}">
											</div>
										</div>
									</div>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="fax_no_3_ext_t5" id="fax_no_3_ext_t5"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab3['fax_no_3_ext_t5'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="mobile_no1_ext_3_t5" id="mobile_no1_ext_3_t5"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab3['mobile_no1_ext_3_t5'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
												...
												<input type="number" name="mobile_no1_3_t5"
													class="form-control input-sm"
													value="{{$tab3['mobile_no1_ext_3_t5']}}">
											</div>
										</div>
									</div>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="mobile_no2_ext_3_t5" id="mobile_no2_ext_3_t5"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab3['mobile_no2_ext_3_t5'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
												...
												<input type="number" name="mobile_no2_3_t5"
													class="form-control input-sm"
													value="{{$tab3['mobile_no2_ext_3_t5']}}">
											</div>
										</div>
									</div>
									...
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<select name="marine_activity_authorized_3_t5" multiple
												id="marine_activity_authorized_3_t5" onchange="regFees()"
												class="form-control select2">
												<option value="">Select</option>
												@foreach ($marine_activity as $item)
												<option value="{{$item->id}}"
													{{(in_array($item->id, explode(',', $tab3['marine_activity_authorized_3_t5']))) ? 'selected' : ''}}>
													{{$item->name}}</option>
												@endforeach
											</select>
										</div>
									...
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<select name="unit_area_of_activity_3_t5" multiple
												id="unit_area_of_activity_3_t5" onchange="regFees()"
												class="form-control select2">
												<option value="">Select</option>
												@foreach ($unit_area_of_activity as $item)
												<option value="{{$item->id}}"
													{{(in_array($item->id, explode(',', $tab3['unit_area_of_activity_3_t5']))) ? 'selected' : ''}}>
													{{$item->name}}</option>
												@endforeach
											</select>
										</div>
								...
								<div class="row">
									...
									<div class="col-lg-12">
										...
										<div class="row">
											<div class="col-md-4">
												...
												<label for="" id="lbl5_name">{{Auth::user()->name}}</label>
											</div>
											<div class="col-md-4">
												<label for="">Email:</label><br />
												<label for="" id="lbl5_email">{{Auth::user()->email}}</label>
											</div>
											<div class="col-md-4">
									...
									<div class="col-lg-12">
										<button class="btn btn-default float-right ml-2" name="btn_submit_t5" disabled
											onclick="submit_t5()">Confirm</button>
										<button class="btn btn-default float-right"
											onclick="wiz5_prevbutton(this)">Previous</button>
									</div>
								</div>
...
<script>
	...
	var verticalWizard_t5 = $("#vertical-wizard_t5").steps({
		...
		onStepChanging: function (event, currentIndex, newIndex) {
			...
			if(currentIndex == 0) {
				if($('[name="id_number_1_t5"]').val() == '' && $('[name="passport_number_1_t5"]').val() == '') {
					toastr['error']('Please fill atleast one of the two fields ID number or Passport number');
					$('[name="id_number_1_t5"], [name="passport_number_1_t5"]').focus();
					return false;
				}
			} else if (currentIndex == 1) {
				if($('[name="id_number_2_t5"]').val() == '' && $('[name="passport_number_2_t5"]').val() == '') {
					toastr['error']('Please fill atleast one of the two fields ID number or Passport number');
					$('[name="id_number_2_t5"], [name="passport_number_2_t5"]').focus();
					return false;
				}
			}
	...
	function save_tab1_t5(tab_index) {
		...
		$(nameArr).each(function(i, element) {
			...
			if(name == 'same_as_applicant_2_t5') {
				if($("input[name='same_as_applicant_2_t5']").is(':checked')) {
					formData.append('same_as_applicant_2_t5', "y");
				} else {
					formData.append('same_as_applicant_2_t5', "");
				}
			} else {
		...
		$.ajax({
			url: "{{url('application')}}/tab5_t"+tab_index,
	...
	function submit_t5() {
		...
		$.ajax({
			url: "{{url('application')}}/confirm_tab5",
			type: "POST",
			data: formData,
			cache: false,
			processData: false,
	...
	function regFees($entitySum = 0) {
		...
		let activityId = [];
		let protectedAreaId = [];
		$('#marine_activity_authorized_3_t5 option').each(function() {
			if ($(this).is(':selected')) {
				activityId.push($(this).val());
			}
		});
		$('#unit_area_of_activity_3_t5 option').each(function() {
			if ($(this).is(':selected')) {
...
/*
	...
	*/
	$(function() {
		$('#nationality_1_t5').trigger('change');
		$('#nationality_2_t5').trigger('change');
	})
	function nationalityChange() {
		var select_val = $('#nationality_1_t5').val().toLowerCase();
		if(select_val && select_val == 'egyptian') {
			$('[name="id_number_1_t5"],[name="passport_number_1_t5"]').prop('disabled', false);
		} else {
			$('[name="id_number_1_t5"]').prop('disabled', true);
		}
	}

	function nationality2Change() {
		var select_val = $('#nationality_2_t5').val().toLowerCase();
		if(select_val && select_val == 'egyptian') {
			$('[name="id_number_2_t5"],[name="passport_number_2_t5"]').prop('disabled', false);
		} else {
			$('[name="id_number_2_t5"]').prop('disabled', true);
		}
	}
