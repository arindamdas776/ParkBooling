	...
	<div class="container-fluid">
		<div class="row page-titles">
			<div class="col-md-5 col-12 align-self-center">
				<h3 class="text-white">{{__("Review Form")}}</h3>
				<ol class="breadcrumb ">
					<li class="breadcrumb-item"><a class="text-white" href="{{ url('dashboard') }}">Home</a></li>
					<li class="breadcrumb-item active text-white">{{__("Review Form")}}</li>
				</ol>
			</div>
					...
					<div class="card-body">
						<div class="row bg-white">
							...
							<div class="col-md-12" id="printableArea">
								...
								<h3 class="text-center">{{__("Review Form")}}</h3>
								@php
									...
									<div class="col-lg-12">
										...
										<div class="row">
											<div class="col-md-4">
												...
												<label for="" id="lbl3_name" class="info">{{Auth::user()->name}}</label>
											</div>
											<div class="col-md-4">
												<label for="">{{__("Email")}}:</label><br />
												<label for="" id="lbl3_email"
