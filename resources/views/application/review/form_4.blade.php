														...
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for=""
																		id="lbl_mobile_work_ext_1_t4"></label>)
																</td>
																<td>
																...
																<table>
																	<tr>
																		<td>
																			<label>CODE<code>*</code></label><br />
																			(<label for=""
																				id="lbl_land_with_ext_2_t4"></label>)
																		</td>
																		<td>
																	...
																	<tr>
																		...
																		<td>
																			<label for="">MOBILE
																				(PERSONAL)</label><br />
																			<label
																				id="lbl_mobile_personal_2_t4"></label>
																		</td>
																	</tr>
																</table>
														...
														<div class="row">
															...
															<div class="col-md-4 mb-2">
																<label for="">License number of the Ministry of Tourism
																	<code>*</code></label><br />
																<label for=""
																	id="lbl_license_number_ministry_of_3_t4"></label>
															</div>
															<div class="col-md-4 mb-2">
															...
															<div class="col-md-4 mb-2">
																<label for="">Tax card
																	number<code>*</code></label><br />
																<label id="lbl_tax_card_no_3_t4"></label>
															</div>
															<div class="col-md-4 mb-2">
																<label for="">Address of the
																	Center<code>*</code></label><br />
																<label for=""
																	id="lbl_address_of_the_center_3_t4"></label>
															</div>
															<div class="col-md-4 mb-2">
																<table>
																	<tr>
															...
															<div class="col-lg-4 mb-2">
																<label for="">Marine activities to be
																	authorized</label><br />
																<label for=""
																	id="lbl_marine_activity_authorized_3_t4"></label>
															</div>
															<div class="col-lg-4 mb-2">
																<label for="">Unit's area of ​​activity (as per the
																	attached statement and maps)</label><br />
																<label for=""
																	id="lbl_unit_area_of_activity_3_t4"></label>
															</div>
														</div>
													</div>
												</div>
													...
													<div class="col-lg-12">
														...
														<div class="checkbox">
															<label style="margin-left:30px;"><input type="checkbox"
																	name="accpet_terms_t4"
																	onclick="accept_terms_t4(this)" value="">I accept
