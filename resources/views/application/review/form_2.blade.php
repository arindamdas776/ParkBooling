					...
					<div class="card-body">
						<div class="row bg-white">
							...
							<div class="col-lg-12 text-right">
								<input type="button" id="noprint" class="noprint printbtn"
							...
							<div class="col-md-12" id="printableArea">
								...
								@php
								if ($application->status == 'freject' || $application->ceo_status == 'lreject')
								$label = '<label class="badge badge-danger">Rejected</label>';
								else if ($application->status == 'review')
								$label = '<label class="badge badge-warning">Employee Review Approval</label>';
								elseif ($application->status == 'fapprove' && $application->ceo_status == 'review')
								$label = '<label class="badge badge-primary">CEO Review Approval</label>';
								elseif ($application->ceo_status == 'lapprove')
								...
								<div class="row">
									...
									<div class="col-lg-12">
										<div class="row">
											<div class="col-lg-8">
												<label for=""
													class="text-uppercase"><b><i>{{__("Review Form")}}</i></b></label>
											</div>
											<div class="col-lg-4 text-right">
												<label for="" class="text-uppercase"><b><i>{{__("Step")}}
															6-6</i></b></label>
											</div>
											<div class="col-lg-12">
												...
												<div class="row">
													<div class="col-md-4">
														...
														<label for="" id="lbl2_name"
															class="info">{{Auth::user()->name}}</label>
													</div>
													<div class="col-md-4">
														<label for="">{{__("Email")}}:</label><br />
														<label for="" id="lbl2_email"
															class="info">{{Auth::user()->email}}</label>
													</div>
													<div class="col-md-4">
												...
												<div class="col-lg-12" id="wrapper_view_t2">
													<div class="row">
															...
															<table>
																<tr>
																	<td>
																		...
																		(<label for=""
																			id="lbl_land_with_ext_1_t2"></label>)
																	</td>
																	<td>
																		<label>{{__("LAND LINE (WITH CODE)")}}<code>*</code></label><br />
																		<label for=""
																			id="lbl_land_with_code_1_t2"></label>
																	</td>
																</tr>
															</table>
															...
															<table>
																<tr>
																	<td>
																		<label>{{__("CODE")}}<code>*</code></label><br />
																		(<label for=""
																			id="lbl_fax_with_ext_1_t2"></label>)
																	</td>
																	<td>
																		<label>{{__("FAX (WITH CODE)")}}</label><br />
																		<label for=""
																			id="lbl_fax_with_code_1_t2"></label>
																	</td>
																</tr>
															</table>
															...
															<table>
																<tr>
																	...
																	<td>
																		...
																		<label for=""
																			id="lbl_mobile_personal_1_t2"></label>
																	</td>
																</tr>
															</table>
														</div>
															...
															<table>
																<tr>
																	<td>
																		<label>{{__("CODE")}}<code>*</code></label><br />
																		(<label for=""
																			id="lbl_mobile_work_ext_1_t2"></label>)
																	</td>
																	<td>
														...
														<div class="col-lg-4 mb-2">
															<label>{{__("Agency bond number")}}
																<code>*</code></label><br />
															<label for="" id="lbl_agency_board_1_t2"></label>
														</div>
														<div class="col-lg-4 mb-2">
															<label>{{__("Documentation Office")}}
																<code>*</code></label><br />
													...
													<div class="row">
														...
														<div class="row">
															...
															<div class="col-md-4">
																<label
																	for="">{{__("Passport number (for non-Egyptians)")}}
																	<code>*</code></label><br />
																...
																<table>
																	<tr>
																		<td>
																			<label>{{__("CODE")}}<code>*</code></label><br />
																			(<label for=""
																				id="lbl_land_with_ext_2_t2"></label>)
																		</td>
																		<td>
																			<label
																...
																<table>
																	<tr>
																		<td>
																			<label>{{__("CODE")}}<code>*</code></label><br />
																			(<label for=""
																				id="lbl_fax_with_ext_2_t2"></label>)
																		</td>
																		<td>
																			<label
																...
																<table>
																	<tr>
																		...
																		<td>
																			...
																			<label
																				id="lbl_mobile_personal_2_t2"></label>
																		</td>
																	</tr>
																</table>
															...
															<div class="col-md-4 mb-2">
																<label
																	for="">{{__("EMAIL (WORK)")}}<code>*</code></label><br />
														...
														<div class="row">
															...
															<div class="col-md-4 mb-2">
																<label
																	...
																	<code>*</code></label><br />
																<label for=""
																	id="lbl_license_number_ministry_of_3_t2"></label>
															</div>
															<div class="col-md-4 mb-2">
																<label for="">
															...
															<div class="col-md-4 mb-2">
																<label for=""><label
																		for="">{{__("Commercial Registration No")}}</label><code>*</code></label><br />
															...
															<div class="col-md-4 mb-2">
																...
																<label for=""
																	id="lbl_address_of_the_center_3_t2"></label>
															</div>
															<div class="col-md-4 mb-2">
																<table>
																	<tr>
																		<td>
																			<label>{{__("CODE")}}<code>*</code></label><br />
																			(<label for=""
																				id="lbl_telephone_ext_3_t2"></label>)
																		</td>
																		<td>
																			<label
																				for="">{{__("Landline number")}}</label><br />
																			<label for=""
																				id="lbl_landline_no_3_t2"></label>
																		</td>
																	</tr>
																</table>
																...
																<table>
																	<tr>
																		<td>
																			<label>{{__("CODE")}}<code>*</code></label><br />
																			(<label for=""
																				id="lbl_fax_with_ext_3_t2"></label>)
																		</td>
																		<td>
															...
															<div class="col-md-4 mb-2">
																<table>
																	<tr>
																		...
																		<td>
																			<label
																				for="">{{__("MOBILE NO 2")}}</label><br />
																			<label for=""
																				id="lbl_mobile_no2_3_t2"></label>
																		</td>
																	</tr>
																</table>
															</div>
															...
															<div class="col-lg-4 mb-2">
																...
																<label for=""
																	id="lbl_marine_activity_authorized_3_t2"></label>
															</div>
															<div class="col-lg-4 mb-2">
																<label
																	for="">{{__("Unit's area of ​​activity (as per the attached statement and maps)")}}</label><br />
																<label for=""
																	id="lbl_unit_area_of_activity_3_t2"></label>
															</div>
														</div>
													</div>
													<div class="row">
														<div class="col-md-12 text-center">
															<label for=""
																class=""><b><i>{{__("BRANCHES")}}</i></b></label>
														</div>
														<div class="row">
															<div class="col-lg-12">
																<label
													...
													<div class="row">
														<div class="col-md-12 text-center">
															<label for=""
																class=""><b><i>{{__("Reg Fess")}}</i></b></label>
														</div>
														<div class="row">
															<div class="col-lg-12">
																<label
