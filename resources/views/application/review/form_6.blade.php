															...
															<table>
																<tr>
																	...
																	<td>
																		...
																		<label for=""
																			id="lbl_land_with_code_1_t6"></label>
																	</td>
																</tr>
															</table>
															...
															<table>
																<tr>
																	...
																	<td>
																		...
																		<label for=""
																			id="lbl_fax_with_code_1_t6"></label>
																	</td>
																</tr>
															</table>
														</div>
														...
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for=""
																		id="lbl_mobile_work_ext_1_t6"></label>)
																</td>
																<td>
																		...
																		<tr>
																			...
																			<td>
																				<label for="">LAND LINE (WITH
																					CODE)</label><br />
																				<label
																					id="lbl_land_with_code_2_t6"></label>
																			</td>
																		</tr>
																	</table>
																</div>
																	...
																	<tr>
																		...
																		<td>
																			<label for="">MOBILE
																				(PERSONAL)</label><br />
																			<label
																				id="lbl_mobile_personal_2_t6"></label>
																		</td>
																	</tr>
																</table>
															</div>
													...
													<div class="col-md-12">
														<div class="row">
															...
															<div class="col-md-4 mb-2">
																...
																<label for=""
																	id="lbl_address_of_the_entity_3_t6"></label>
															</div>
															<div class="col-md-4 mb-2">
																<table>
																	<tr>
															...
															<div class="col-lg-4 mb-2">
																<label for="">Activities to be authorized (temporary
																	permit)</label><br />
																<label for=""
																	id="lbl_marine_activity_authorized_3_t6"></label>
															</div>
															<div class="col-lg-4 mb-2">
															...
															<div class="col-lg-4 mb-2">
																...
																<label for=""
																	id="lbl_unit_area_of_activity_3_t6"></label>
															</div>
														</div>
													</div>
													...
													<div class="col-lg-12">
														...
														<div class="checkbox">
															<label style="margin-left:30px;"><input type="checkbox"
																	name="accpet_terms_t6"
																	onclick="accept_terms_t6(this)" value="">I accept
