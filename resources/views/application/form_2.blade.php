								...
								<div class="row">
									...
									<div class="col-lg-6 mb-2">
										...
										<select name="applicant_status_1_t2" id="applicant_status_1_t2"
											...
											<option value="{{$item}}"
												{{($tab1['applicant_status_1_t2'] == $item) ? 'selected' : ''}}>
												{{$item}}</option>
											@endforeach
										</select>
									</div>
									<div class="col-lg-6 mb-2">
										...
										<select name="nationality_1_t2" id="nationality_1_t2"
											...
											<option value="{{$item}}"
												{{($tab1['nationality_1_t2'] == $item) ? 'selected' : ''}}>{{$item}}
											</option>
											@endforeach
										</select>
									</div>
									...
									<div class="col-lg-4">
										...
										<div class="form-group">
											<input type="text" name="passport_number_1_t2" class="form-control input-sm"
												value="{{$tab1['passport_number_1_t2']}}">
										</div>
									</div>
									<div class="col-lg-4">
									...
									<div class="col-lg-4 mt-3">
										...
										<div class="form-group">
											<input type="text" name="actual_place_of_res_1_t2"
												...
												value="{{$tab1['actual_place_of_res_1_t2']}}">
										</div>
									</div>
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<textarea class="form-ccontrol" style="width: 100%;" name="corrs_add_1_t2"
												id="corrs_add_1_t2" cols="5"
												rows="3">{{$tab1['corrs_add_1_t2']}}</textarea>
										</div>
									</div>
									<div class="col-lg-6 mb-2">
										...
										<div class="form-group">
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="land_with_ext_1_t2" id="land_with_ext_1_t2"
														...
														<option value="{{$country->phonecode}}"
															{{($tab1['land_with_ext_1_t2'] == $country->phonecode) ? 'selected' : ''}}>
												...
												<input type="number" name="land_with_code_1_t2"
													class="form-control input-sm"
													value="{{$tab1['land_with_code_1_t2']}}">
											</div>
										</div>
									</div>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="fax_with_ext_1_t2" id="fax_with_ext_1_t2"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab1['fax_with_ext_1_t2'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="mobile_personal_ext_1_t2"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab1['mobile_personal_ext_1_t2'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
												...
												<input type="number" name="mobile_personal_1_t2"
													class="form-control input-sm"
													value="{{$tab1['mobile_personal_1_t2']}}">
											</div>
										</div>
									</div>
									<div class="col-lg-6 mb-2">
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="mobile_work_ext_1_t2" id="mobile_work_ext_1_t2"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab1['mobile_work_ext_1_t2'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
												...
												<input type="number" name="mobile_work_1_t2"
													class="form-control input-sm" value="{{$tab1['mobile_work_1_t2']}}">
											</div>
										</div>
									</div>
									...
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<input type="email" name="email_personal_1_t2" class="form-control input-sm"
												value="{{$tab1['email_personal_1_t2']}}">
										</div>
									</div>
									<div class="col-lg-4 mb-2">
									...
									<div class="col-lg-4 mb-2">
										...
										<select name="reqtype_1_t2" id="reqtype_1_t2" class="form-control select2">
											...
											<option value="{{$item}}"
												{{($tab1['reqtype_1_t2'] == $item) ? 'selected' : ''}}>{{$item}}
											</option>
											@endforeach
										</select>
									</div>
									<div class="col-lg-4 mb-2">
										...
										<textarea name="notes_1_t2" id="notes_1_t2" cols="30"
											rows="2">{{$tab1['name_1_t2']}}</textarea>
									</div>

									<div class="col-lg-12">
										<button class="btn btn-default float-right ml-2"
											onclick="wiz2_nextbutton(this)">{{__('Save & Next')}}</button>
									</div>
								</div>
							</section>

							<h3>{{__("Center owner data")}}</h3>
							<section data-tab="2">
								<div class="row">
									<div class="col-lg-8">
										<label for=""
											class="text-uppercase"><b><i>{{__("Center owner data")}}</i></b></label>
									</div>
									<div class="col-lg-4 text-right">
										...
										<div class="col-lg-12">
											...
											<div class="checkbox">
												<label style="margin-left:30px;"><input type="checkbox"
														name="same_as_applicant_2_t2"
														value="{{($tab2['same_as_applicant_2_t2'] == "y") ? 'y' : ''}}"
														{{($tab2['same_as_applicant_2_t2'] == "y") ? 'checked' : ''}}>{{__("Same as applicants data")}}</label>
											</div>
										</div>
									</div>
									...
									<div class="col-lg-12 mb-2">
										...
										<select name="nationality_2_t2" id="nationality_2_t2"
											...
											@foreach ($nationality as $item)
											<option value="{{$item}}"
												{{($tab2['nationality_2_t2'] == $item) ? 'selected' : ''}}>{{$item}}
											</option>
											@endforeach
										</select>
									</div>
									...
									<div class="col-lg-4">
										...
										<div class="form-group">
											<input type="text" name="passport_number_2_t2" class="form-control input-sm"
												value="{{$tab2['passport_number_2_t2']}}">
										</div>
									</div>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="land_with_ext_2_t2" id="land_with_ext_2_t2"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab2['land_with_ext_2_t2'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
												...
												<input type="number" name="land_with_code_2_t2"
													class="form-control input-sm"
													value="{{$tab2['land_with_code_2_t2']}}">
											</div>
										</div>
									</div>
									<div class="col-lg-6 mb-2">
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="fax_with_ext_2_t2" id="fax_with_ext_2_t2"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab2['fax_with_ext_2_t2'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="mobile_personal_ext_2_t2"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab2['mobile_personal_ext_2_t2'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
												...
												<input type="number" name="mobile_personal_2_t2"
													class="form-control input-sm"
													value="{{$tab2['mobile_personal_2_t2']}}">
											</div>
										</div>
									</div>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="mobile_work_ext_2_t2" id="mobile_work_ext_2_t2"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab2['mobile_work_ext_2_t2'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
												...
												<input type="number" name="mobile_work_2_t2"
													class="form-control input-sm" value="{{$tab2['mobile_work_2_t2']}}">
											</div>
										</div>
									</div>
									...
									<div class="col-lg-4 mb-2">
										<label for="">{{__("EMAIL (PERSONAL)")}}</label>
										<div class="form-group">
											<input type="email" name="email_personal_2_t2" class="form-control input-sm"
												value="{{$tab2['email_personal_2_t2']}}">
										</div>
									</div>
									...
									<div class="col-lg-12">
										...
										<button class="btn btn-default float-right"
											onclick="wiz2_prevbutton(this)">{{__("Previous")}}</button>
									</div>
								</div>
							</section>

							<h3>{{__("Center data (based on official documents)")}}</h3>
							<section data-tab="3">
								<div class="row">
									<div class="col-lg-8">
										<label for=""
											class="text-uppercase"><b><i>{{__("Center data (based on official documents)")}}</i></b></label>
									</div>
									<div class="col-lg-4 text-right">
									...
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<input type="text" name="center_name_arabic_3_t2"
												class="form-control input-sm"
												value="{{$tab3['center_name_arabic_3_t2']}}">
										</div>
									</div>
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<input type="text" name="center_name_english_3_t2"
												class="form-control input-sm"
												value="{{$tab3['center_name_english_3_t2']}}">
										</div>
									</div>
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<input type="text" name="license_number_ministry_of_3_t2"
												class="form-control input-sm"
												value="{{$tab3['license_number_ministry_of_3_t2']}}">
										</div>
									</div>
									<div class="col-lg-4 mb-2">
										<label for="">
											{{__("License number of the Ministry of Tourism Membership Number of Diving Tourism Rooms")}}
											<code>*</code></label>
										<div class="form-group">
											<input type="text" name="license_number_ministry_of_membership_3_t2"
												class="form-control input-sm"
												value="{{$tab3['license_number_ministry_of_membership_3_t2']}}">
										</div>
									</div>
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<input type="number" name="commercial_reg_no_3_t2"
												class="form-control input-sm"
												value="{{$tab3['commercial_reg_no_3_t2']}}">
										</div>
									</div>
									<div class="col-lg-4 mb-2">
									...
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<textarea name="address_of_the_center_3_t2" id="address_of_the_center_3_t2"
												cols="30" rows="3">{{$tab3['address_of_the_center_3_t2']}}</textarea>
										</div>
									</div>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="telephone_ext_3_t2" id="telephone_ext_3_t2"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab3['telephone_ext_3_t2'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
												...
												<input type="number" name="landline_no_3_t2"
													class="form-control input-sm" value="{{$tab3['landline_no_3_t2']}}">
											</div>
										</div>
									</div>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="fax_with_ext_3_t2" id="fax_with_ext_3_t2"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab3['fax_with_ext_3_t2'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="mobile_no1_ext_3_t2" id="mobile_no1_ext_3_t2"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab3['mobile_no1_ext_3_t2'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
												...
												<input type="number" name="mobile_no1_3_t2"
													class="form-control input-sm" value="{{$tab3['mobile_no1_3_t2']}}">
											</div>
										</div>
									</div>
											...
											<div class="input-group">
												<div class="input-group-prepend country_ext">
													+<select name="mobile_no2_ext_3_t2" id="mobile_no2_ext_3_t2"
														...
														@foreach ($countries as $country)
														<option value="{{$country->phonecode}}"
															{{($tab3['mobile_no2_ext_3_t2'] == $country->phonecode) ? 'selected' : ''}}>
															{{$country->phonecode}} - {{$country->country_name}}
														</option>
														@endforeach
													</select>
												...
												<input type="number" name="mobile_no2_3_t2"
													class="form-control input-sm" value="{{$tab3['mobile_no2_3_t2']}}">
											</div>
										</div>
									</div>
										...
										<div class="form-group">
											<select name="marine_activity_authorized_3_t2" multiple
												...
												<option value="{{$item->id}}"
													{{(in_array($item->id, explode(',', $tab3['marine_activity_authorized_3_t2']))) ? 'selected' : ''}}>
													{{$item->name}}</option>
												@endforeach
											</select>
										</div>
									...
									<div class="col-lg-4 mb-2">
										...
										<div class="form-group">
											<select name="unit_area_of_activity_3_t2" multiple
												...
												<option value="{{$item->id}}"
													{{(in_array($item->id, explode(',', $tab3['unit_area_of_activity_3_t2']))) ? 'selected' : ''}}>
													{{$item->name}}</option>
												@endforeach
											</select>
										</div>
								...
								<div class="row">
									...
									<div class="col-lg-12">
										...
										<div class="row">
											<div class="col-md-4">
												...
												<label for="" id="lbl2_name">{{Auth::user()->name}}</label>
											</div>
											<div class="col-md-4">
												<label for="">{{__("Email")}}:</label><br />
												<label for="" id="lbl2_email">{{Auth::user()->email}}</label>
											</div>
											<div class="col-md-4">
										...
										<div class="col-lg-12" id="wrapper_view_t2">
											...
											<div class="row">
												<div class="col-md-12">
													<label for=""
														class="text-center"><b><i>{{__("CENTER OWNER DATA")}}</i></b></label>
												</div>
												<div class="row">
													<div class="col-md-12">
											...
											<div class="row">
												<div class="col-md-12">
													<label for=""
														class="text-center"><b><i>{{__("CENTER DATA (BASED ON OFFICIAL DOCUMENTS)")}}</i></b></label>
												</div>
												<div class="row">
													<div class="col-md-4 mb-2">
									...
									<div class="col-lg-12">
										<button class="btn btn-default float-right ml-2" name="btn_submit_t2" disabled
											onclick="submit_t2()">{{__("Confirm")}}</button>
										<button class="btn btn-default float-right"
											onclick="wiz2_prevbutton(this)">{{__("Previous")}}</button>
									</div>
								</div>
...
<script>
	...
	function personalCred() {
		...
		if(name != '' && email != '' && password != '' && reg_type !='') {
			if(!pattern.test(email)) {
				toastr['error']('{{__("Not a valid email address")}}');
				return false;
	...
	$.validator.addMethod(
        ...
        '{{__("Accept Only Arabic & English Text.")}}'
	);
	...
	var verticalWizard_t2 = $("#vertical-wizard_t2").steps({
		...
		onStepChanging: function (event, currentIndex, newIndex) {
			...
			if(currentIndex == 0) {
				if($('[name="id_number_1_t2"]').val() == '' && $('[name="passport_number_1_t2"]').val() == '') {
					toastr['error']('Please fill atleast one of the two fields ID number or Passport number');
					$('[name="id_number_1_t2"], [name="passport_number_1_t2"]').focus();
					return false;
				}
			} else if (currentIndex == 1) {
				if($('[name="id_number_2_t2"]').val() == '' && $('[name="passport_number_2_t2"]').val() == '') {
					toastr['error']('Please fill atleast one of the two fields ID number or Passport number');
					$('[name="id_number_2_t2"], [name="passport_number_2_t2"]').focus();
					return false;
				}
			}
		...
		onStepChanged: function (event, currentIndex, priorIndex) {
			...
			if(currentIndex == 5) {
				...
				$('#lbl_payment_fees_t2').text($('[name="payment_fees"]').val());

				$('#lbl_land_with_ext_1_t2').text($('[name="land_with_ext_1_t2"]').val());
				$('#lbl_fax_with_ext_1_t2').text($('[name="fax_with_ext_1_t2"]').val());
				$('#lbl_mobile_personal_ext_1_t2').text($('[name="mobile_personal_ext_1_t2"]').val());
				$('#lbl_mobile_work_ext_1_t2').text($('[name="mobile_work_ext_1_t2"]').val());

				$('#lbl_land_with_ext_2_t2').text($('[name="land_with_ext_2_t2"]').val());
				$('#lbl_fax_with_ext_2_t2').text($('[name="fax_with_ext_2_t2"]').val());
				$('#lbl_mobile_personal_ext_2_t2').text($('[name="mobile_personal_ext_2_t2"]').val());
				$('#lbl_mobile_work_ext_2_t2').text($('[name="mobile_work_ext_2_t2"]').val());

				$('#lbl_telephone_ext_3_t2').text($('[name="telephone_ext_3_t2"]').val());
				$('#lbl_fax_with_ext_3_t2').text($('[name="fax_with_ext_3_t2"]').val());
				$('#lbl_mobile_no1_ext_3_t2').text($('[name="mobile_no1_ext_3_t2"]').val());
				$('#lbl_mobile_no2_ext_3_t2').text($('[name="mobile_no2_ext_3_t2"]').val());
	...
	function save_tab1_t2(tab_index) {
		...
		$(nameArr).each(function(i, element) {
			...
			if(name == 'same_as_applicant_2_t2') {
				if($("input[name='same_as_applicant_2_t2']").is(':checked')) {
					formData.append('same_as_applicant_2_t2', "y");
				} else {
					formData.append('same_as_applicant_2_t2', "");
				}
			} else {
		...
		$.ajax({
			url: "{{url('application')}}/tab2_t"+tab_index,
	...
	function submit_t2() {
		...
		$.ajax({
			url: "{{url('application')}}/confirm_tab2",
			type: "POST",
			data: formData,
			cache: false,
			processData: false,
				...
				if(data) {
					...
					for(var i in data.upload_doc) {
						...
						$('.col-wrapper-doc').append(`<div class="col-lg-6">
																...
																<a href="{{url('/')}}/${data.upload_doc[i]}" target="_blank">{{__("Uploaded File")}}</a>
															</div>
													 </div>`);
					}
					$('#lbl_marine_activity_authorized_3_t2').html(data.center_data.marine_activity_authorized_3_t2);
					$('#lbl_unit_area_of_activity_3_t2').html(data.center_data.unit_area_of_activity_3_t2);
					$('#lbl_payment_fees_t2').text(data.no_of_branches);
				}
			},
	...
	$(document).ready(function() {
		$("input[type='number']").keypress(function(e) {
			if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
				$(".errmsg").html('{{__("Digits Only")}}').show().fadeOut("slow");
				return false;
			}
		});
	...
	function regFees($entitySum = 0) {
		...
		let activityId = [];
		let protectedAreaId = [];
		$('#marine_activity_authorized_3_t2 option').each(function() {
			if ($(this).is(':selected')) {
				activityId.push($(this).val());
			}
		});
		$('#unit_area_of_activity_3_t2 option').each(function() {
			if ($(this).is(':selected')) {
	...
	*/
	$(function() {
		$('#nationality_1_t2').trigger('change');
		$('#nationality_2_t2').trigger('change');
	})
	function nationalityChange() {
		var select_val = $('#nationality_1_t2').val().toLowerCase();
		if(select_val && select_val == 'egyptian') {
			$('[name="id_number_1_t2"],[name="passport_number_1_t2"]').prop('disabled', false);
		} else {
			$('[name="id_number_1_t2"]').prop('disabled', true);
		}
	}

	function nationality2Change() {
		var select_val = $('#nationality_2_t2').val().toLowerCase();
		if(select_val && select_val == 'egyptian') {
			$('[name="id_number_2_t2"],[name="passport_number_2_t2"]').prop('disabled', false);
		} else {
			$('[name="id_number_2_t2"]').prop('disabled', true);
		}
	}
