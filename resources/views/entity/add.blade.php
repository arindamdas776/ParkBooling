        ...
        <div class="row page-titles">
            <div class="col-md-5 col-12 align-self-center">
                ...
                <ol class="breadcrumb ">
                    ...
                    <li class="breadcrumb-item"><a class="text-white" href="{{ route('entities.index') }}">Entities</a>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" onkeypress="return isNumberKey(this, event);" type="tel"
                                    placeholder="Enter Annual average" name="annual_average" required>
                            </div>
                            <div class="form-group">
                                ...
                                <input class="form-control" onkeypress="return isNumberKey(this, event);" type="tel"
                                    ...
                                    name="annual_protection_fees" required>
                            </div>
                            <div class="form-group">
                                ...
                                <input readonly class="form-control numeric" type="tel" placeholder="{{__("Basic quota ")}}"
                                    name="annual_allowed_tickets" required>
                            </div>
                            <div class="form-group">
                                ...
                                <input readonly class="form-control numeric" type="tel" placeholder="{{__("Additional quota ")}}"
                                    name="extra_ticket_category" required>
                            </div>
                            <div class="form-group">
                                ...
                                <input readonly class="form-control numeric" type="tel" placeholder="Extra Ticket category fees"
                                    name="extra_ticket_category_fees" required>
                            </div>
                        </div>
