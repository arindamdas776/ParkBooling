                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="tel" placeholder="Enter Fees" name="fees" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Average Annual (اﻟﻤﺘﻮﺳﻂ اﻟﺴﻨﻮي ﻟﻘﯿﻤﺔ ﺗﻜﺎﻟﯿﻒ اﻟﺤﻤﺎﯾﺔ ﻟﻠﻤﻮارد اﻟﻄﺒﯿﻌﯿﺔ)</label>
                                <input class="form-control" type="tel" placeholder="Enter Annual average" name="annual_average" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Annual protection fees (ﻣﻌﺎﻣﻞ ﺗﻜﺎﻟﯿﻒ اﻟﺤﻤﺎﯾﺔ اﻟﺴﻨﻮﯾﺔ ﻟﻠﻤﻮارد)</label>
                                <input class="form-control" type="tel" placeholder="Enter annual protection fees" name="annual_protection_fees" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Annual allowed tickets (اﻷﺳﺎﺳﯿﺔ اﻟﺸﺮاﺋﺢ)</label>
                                <input class="form-control" type="tel" placeholder="Enter annual allowed tickets" name="annual_allowed_tickets" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Extra ticket category (Range of number of tickets) (اﻹﺿﺎﻓﯿﺔ اﻟﺸﺮاﺋﺢ)</label>
                                <input class="form-control" type="tel" placeholder="Enter extra ticket category" name="extra_ticket_category" required>
                            </div>
                        </div>
