    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 col-12 align-self-center">
                <h3 class="text-white">{{__('Vessels')}}</h3>
                <ol class="breadcrumb ">
                    <li class="breadcrumb-item"><a class="text-white" href="{{ url('dashboard') }}">{{__("Home")}}</a>
                    </li>
                    <li class="breadcrumb-item"><a class="text-white"
                            href="{{ route('vessels.index') }}">{{__('Vessels')}}</a>
                    </li>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form action="{{route('vessels.update', ['vessel' => $vessel->id])}}" id="updateForm" method="POST"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="name" value="{{$vessel->name}}" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">{{__("Name (Arabic)")}}</label>
                                <input class="form-control" type="text" name="name_arabic" value="{{$vessel->name_arabic}}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="description"
                                    value="{{$vessel->description}}" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">{{__("Description (Arabic)")}}</label>
                                <input class="form-control" type="text" name="description_arabic" value="{{$vessel->description_arabic}}" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">{{__("Type")}}</label>
                                <input class="form-control" type="text" name="type" value="{{$vessel->type}}" required>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="port">
                                    ...
                                    <option value="{{ $item->id }}" {{($vessel->port_id == $item->id) ? 'selected':''}}>
                                        {{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="craft">
                                    ...
                                    <option value="{{ $item->id }}"
                                        {{($vessel->craft_id == $item->id) ? 'selected':''}}>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="length">
                                    ...
                                    <option value="{{ $item->id }}"
                                        {{($vessel->length_id == $item->id) ? 'selected':''}}>{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="construction_type">
                                    <option value="Safari" {{($vessel->construction_type == 'Safari') ? 'selected':''}}>
                                        Safari</option>
                                    <option value="Marine" {{($vessel->construction_type == 'Marine') ? 'selected':''}}>
                                        Marine</option>
                                </select>
                            </div>
                        </div>
