...
<div class="login-register" style="background-image: url({{url('assets/images/background/login-register.jpg')}})">
    <div class="login-box card mt-3 mb-2">
        <div class="card-body ">
            <form id="SubmitForm" method="POST" action="{{ route('pwd.reset.link') }}">
                @csrf
                ...
                <div class="form-group text-center m-t-20">
                    <div class="col-xs-12">
                        <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" id="signupBtn"  type="submit">{{ __('Reset Password Link') }}</button>
                    </div>
                </div>
