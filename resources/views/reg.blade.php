													...
													<div class="col-lg-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_personal_ext_1_t1"></label>)
																</td>
																<td>
													...
													<div class="col-lg-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_work_ext_1_t1"></label>)
																</td>
																<td>
													...
													<div class="col-lg-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_personal_ext_2_t1"></label>)
																</td>
																<td>
													...
													<div class="col-lg-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_work_ext_2_t1"></label>)
																</td>
																<td>
													...
													<div class="col-lg-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_number_p_ext_3_t1"></label>)
																</td>
																<td>
													...
													<div class="col-lg-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_work_w_ext_3_t1"></label>)
																</td>
																<td>
																	<label for="">MOBILE (WORK) <code>*</code></label><br />
												...
												<div class="col-lg-4 mb-2">
													<table>
														<tr>
															<td>
																<label>CODE<code>*</code></label><br />
																(<label for="" id="lbl_mobile_personal_ext_1_t2"></label>)
															</td>
															<td>
																<label>MOBILE (PERSONAL)</label><br />
													...
													<div class="col-md-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_personal_ext_2_t2"></label>)
																</td>
																<td>
																	<label for="">MOBILE (PERSONAL)</label><br/>
													...
													<div class="col-md-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_work_ext_2_t2"></label>)
																</td>
																<td>
																	<label for="">MOBILE (WORK) <code>*</code></label><br/>
													...
													<div class="col-md-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_no1_ext_3_t2"></label>)
																</td>
																<td>
													...
													<div class="col-md-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_no2_ext_3_t2"></label>)
																</td>
																<td>
												...
												<div class="col-lg-4 mb-2">
													<table>
														<tr>
															<td>
																<label>CODE<code>*</code></label><br />
																(<label for="" id="lbl_mobile_personal_ext_1_t3"></label>)
															</td>
															<td>
																<label>MOBILE (PERSONAL)</label><br />
													...
													<div class="col-md-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_personal_ext_2_t3"></label>)
																</td>
																<td>
																	<label for="">MOBILE (PERSONAL)</label><br/>
													...
													<div class="col-md-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_work_ext_2_t3"></label>)
																</td>
																<td>
																	<label for="">MOBILE (WORK) <code>*</code></label><br/>
													...
													<div class="col-md-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_no1_ext_3_t3"></label>)
																</td>
																<td>
																	<label for="">MOBILE NO1<code>*</code></label><br/>
													...
													<div class="col-md-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_no2_ext_3_t3"></label>)
																</td>
																<td>
																	<label for="">MOBILE NO 2</label><br/>
												...
												<div class="col-lg-4 mb-2">
													<table>
														<tr>
															<td>
																<label>CODE<code>*</code></label><br />
																(<label for="" id="lbl_mobile_personal_ext_1_t4"></label>)
															</td>
															<td>
																<label>MOBILE (PERSONAL)</label><br />
													...
													<div class="col-md-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_fax_with_code_ext_2_t4"></label>)
																</td>
																<td>
																	<label for="">FAX (WITH CODE)</label><br/>
													...
													<div class="col-md-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_personal_ext_2_t4"></label>)
																</td>
																<td>
																	<label for="">MOBILE (PERSONAL)</label><br/>
													...
													<div class="col-md-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_work_ext_2_t4"></label>)
																</td>
																<td>
																	<label for="">MOBILE (WORK) <code>*</code></label><br/>
													...
													<div class="col-md-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_landline_no_ext_3_t4"></label>)
																</td>
																<td>
																	<label for="">Landline number</label><br/>
													...
													<div class="col-md-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_no1_ext_3_t4"></label>)
																</td>
																<td>
																	<label for="">MOBILE NO1<code>*</code></label><br/>
													...
													<div class="col-md-4 mb-2">
														<table>
															<tr>
																<td>
																	<label>CODE<code>*</code></label><br />
																	(<label for="" id="lbl_mobile_no2_ext_3_t4"></label>)
																</td>
																<td>
																	<label for="">MOBILE NO 2</label><br/>
